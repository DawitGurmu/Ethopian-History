 ...
 $host = "localhost"; 
   $dbUsername = "root"; 
    ...
    if (mysqli_connect_error()) { 
     ...
     $SELECT = "SELECT userName From general_registration WHERE userName = ? Limit 1"; //check from database
   $INSERT = "INSERT INTO general_registration (firstName, lastName, userName, country, city, phone) 
   values(?, ?, ?, ?, ?, ?)";
   //Prepare statement 
