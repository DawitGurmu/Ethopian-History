 ...
 $host = "localhost"; 
   $dbUsername = "root"; 
    ...
    if (mysqli_connect_error()) { 
     ...
     $SELECT = "SELECT userName From mentores_registration WHERE userName = ? Limit 1"; //check from database
   $INSERT = "INSERT INTO mentores_registration (firstName, lastName, userName, country, city, phone) 
   values(?, ?, ?, ?, ?, ?)";
   //Prepare statement 
